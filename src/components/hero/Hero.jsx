...
export default function Hero() {
  return (
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[660px] flex flex-col bg-[#0d1117]'>
      ...
      <div className='absolute top-[-80px] right-[-150px] h-[400px] w-[600px] bg-gradient-to-br from-[#161b22] to-[#0d1117] transform rotate-12 skew-y-3 opacity-70 rounded-2xl shadow-[0_0_40px_rgba(22,27,34,0.3)]'>
      </div>
      <div className='absolute top-[100px] left-[-100px] h-[300px] w-[500px] bg-gradient-to-br from-[#238636] to-[#c9d1d9] transform rotate-3 skew-x-3 opacity-50 rounded-3xl shadow-[0_0_40px_rgba(35,134,54,0.2)]'>
      </div>
