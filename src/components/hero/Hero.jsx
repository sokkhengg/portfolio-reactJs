    ...
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[660px] flex flex-col'>
        ...
        className='text-white body-font z-10'>
            <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
                ...
                <h1 className='title-font sm:text-4xl text-4xl mb-4 font-bold text-white'>Hi! I'm Sokheng Teang</h1>
                <p className='mb-8 leading-relaxed'>Innovation Begins with One Line of Code.    
                </p>
